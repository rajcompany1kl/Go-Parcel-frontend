...
export const RideIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 24 24" {...props}>
        <path
            fill="#ffffff"
            d="M4 17V9a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8h-2v-2H6v2H4Zm2-4h12V9H6Zm1 7a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Zm10 0a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3Z"
        />
    </svg>
);

export const FerrariIcon = `
    <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 400 200'>
        <defs>
            ...
            <radialGradient id='wheelGrad' cx='0.3' cy='0.3' r='0.9'>
            <stop offset='0' stop-color='#ccc'/><stop offset='0.6' stop-color='#666'/><stop offset='1' stop-color='#111'/>
            </radialGradient>
        </defs>
        <ellipse cx='200' cy='150' rx='150' ry='20' fill='#000' opacity='0.18'/>
        <path d='M30 120Q60 70,110 60L290 60Q320 60,345 80L360 110Q370 120,345 125L60 125Q45 125,30 120Z' fill='url(#bodyGrad)' stroke='#570000' stroke-width='1.5'/>
        <ellipse cx='120' cy='125' rx='25' ry='25' fill='url(#wheelGrad)' stroke='#111' stroke-width='3'/>
        <ellipse cx='300' cy='125' rx='25' ry='25' fill='url(#wheelGrad)' stroke='#111' stroke-width='3'/>
        <ellipse cx='340' cy='88' rx='6' ry='4' fill='#fff2b8' opacity='0.95'/>
    </svg>`


export const originIcon = `
<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 40'>
  <circle cx='20' cy='20' r='10' fill='#00c853'/>
  <circle cx='20' cy='20' r='5' fill='#fff'/>
  <path d='M20 0 L20 10' stroke='#00c853' stroke-width='3'/>
</svg>`;


export const destinationIcon = `
<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 40 40'>
  <circle cx='20' cy='20' r='10' fill='#d50000'/>
  <circle cx='20' cy='20' r='5' fill='#fff'/>
  <path d='M20 30 L20 40' stroke='#d50000' stroke-width='3'/>
</svg>`;